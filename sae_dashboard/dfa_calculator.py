...
class DFACalculator:
    ...
    def calculate(
        ...
        if self.use_gqa:
            per_src_pos_dfa = self.calculate_gqa_intermediate_tensor(attn_weights, v, feature_indices)
        else:
            per_src_pos_dfa = self.calculate_standard_intermediate_tensor(attn_weights, v, feature_indices)
    ...
    def calculate_gqa_intermediate_tensor(
        ...
        per_src_pos_dfa = torch.zeros((n_prompts, seq_len, seq_len, n_features), device=v_cat.device)
