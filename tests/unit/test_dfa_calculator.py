...
def test_dfa_calculator_initialization(model: HookedTransformer, autoencoder: SAE):  # type: ignore
...
def test_dfa_calculation_shape(
    model: HookedTransformer, autoencoder: SAE, tokens: torch.Tensor  # type: ignore
):
    calculator = DFACalculator(model, autoencoder)
...
def test_functional_equivalence(model: HookedTransformer, autoencoder: SAE):  # type: ignore
    calculator = DFACalculator(model, autoencoder)
...
def test_performance_comparison(model: HookedTransformer, autoencoder: SAE):  # type: ignore
    calculator = DFACalculator(model, autoencoder)
...
def test_different_shapes(model: HookedTransformer, autoencoder: SAE):  # type: ignore
    calculator = DFACalculator(model, autoencoder)
...
def test_edge_cases(model: HookedTransformer, autoencoder: SAE):  # type: ignore
    calculator = DFACalculator(model, autoencoder)
